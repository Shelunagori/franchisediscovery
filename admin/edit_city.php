       ...
       <div class="row">
        <div class="col-md-12">
			...
			{ ?>
				...
				<strong>City updated successfully !</strong> 
				</div>
		  <?php }?>
		  <?php if($status == 'fail')
			{ ?>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit City</h3>
			<a href="cityMaster.php" class="pull-right"> Add New</a>
          
        </div>
        <form role="form" method="post" action="cityMaster.php">
		...
		<div class="box-body">
			<div class="box-body">
             <div class="form-group">
				<input class="form-control" name="name" type="text" placeholder="Add City" value='<?php echo $row['name']; ?>' required>
				...
				<?php $i = 1;
					...
					while($row=mysqli_fetch_array($query)){
						...
						<tr>
							...
							<td>
								<a class="mb-control1 btn btn-danger btn-rounded btn-sm" onclick="return confirm('Are you sure ?')" href="cityMaster.php?id=<?php echo $row['id']; ?>">
