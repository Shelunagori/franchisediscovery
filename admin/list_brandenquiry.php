	...
	if(isset($_GET['ok']))
			{
				...
				{
					echo$where="AND company_name LIKE'%$company_name%'";
				}
				...
				{
					$where=" AND company_name LIKE'%$company_name%' AND email LIKE '%$email%'";
				}
				else if(!$company_name==null && !$email==null && !@$from==null && !@$to==null)
				{
					$where=" AND company_name LIKE'%$company_name%' AND email LIKE '%$email%' AND created_on BETWEEN '$from' AND '$to'";
				}
				else if($company_name==null && $email==null && !@$from==null && @$to==null)
				{
				...
				{
					$where="AND created_on < '$to' AND company_name LIKE'%$company_name%'";
				}
				else if(!$company_name==null && $email==null && !@$from==null && @$to==null)
				{
					$where="AND created_on > '$from' AND company_name LIKE'%$company_name%'";
				}
				else if($company_name==null && !$email==null && !@$from==null && @$to==null)
				{
				...
				{
					$where="AND created_on BETWEEN '$from' AND '$to' AND company_name LIKE'%$company_name%'";
				}
