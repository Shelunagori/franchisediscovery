	...
	$message="";
		$id=base64_decode($_GET['id']);
			...
			if(isset($_POST['submit']))
			{
				...
				$ticket_row_query="INSERT INTO suport_ticket_rows(support_ticket_id,message,attachment_file,employee_id) VALUES ('$id','$message','$file_name','$employee_ids')";
																	  	...
																	  	<h4><?php $user_id=$rows['customer_id'];
																					...
																					<table class="table table-striped">
																						...
																						<tr>
																							...
																							<td><a href="<?php echo '../'.$rows['attachment_file']; ?>" target="_blank"> Click Here </td>
																						</tr>
																						<tr>
															...
															<div class="panel box box-primary">
																...
																<div id="collapsetwo<?=$a?>" class="panel-collapse collapse <?= ($a == mysqli_num_rows($ticket_info_query))?'in':''?>">
																	<div class="box-body">
																	  ...
																	  <a target="_blank" class="mb-control1 btn btn-info btn-rounded btn-sm" href="<?= $attachment_file;?>"><span class="fa fa-file-image-o"></span> Click Here
																	  </a>
																	</div>
																</div>
															</div>
