<?php require('admin/config.php'); 
	...
	$investment = mysqli_real_escape_string($db,$_POST['investment']);
	...
	$sql = "INSERT INTO enquire(enquire_type, name, email, mobile, city, investment, requirment, brand_name, message,enquite_date) 
	VALUES ('$eqtype','$name','$email','$mobile','$city','$investment','$requirment','$brand_name','$message','$enquite_date')";
