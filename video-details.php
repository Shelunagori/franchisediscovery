...
<!-- End Facebook Pixel Code -->
  ...
  <style>
	.singl-video-title h1{ font-size:25px;}
	</style>
                ...
                <div class="col-12 col-lg-8">
                    <div class="singl-blog-post">
                        <figure>
                            <!-- Blog Main Image -->
                            <div class="blog-img">
                                <iframe width="100%" height="400" src="https://www.youtube.com/embed/BeUP68b5am8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>

                            <!-- Blog Title -->
                            <div class="singl-video-title">
                                <h1>Kiss Me Baby Full Song Garam Masala 2005 HD 1080p Music Videos YouTube </h1>
                            </div>
